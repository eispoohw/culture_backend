...
from utils.models import PreparedNonUniqueTitledModel, PreparedTimedModel
from shop.db.models.product import Product, ProductCategory
from shop.db.models.product_unit import ProductUnit


class Discounts(PreparedNonUniqueTitledModel):
    """ Скидки """
...
class Order(PreparedTimedModel):
    """ Заказ """
